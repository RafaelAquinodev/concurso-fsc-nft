...
const premiumItems = [
  {
    text: "Resumo diário das top coleções com IA",
  },
  {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center">
      <div className="grid grid-cols-1 grid-rows-[2fr,1fr] gap-8 sm:grid-cols-2">
        ...
        {/* Basic */}
        <div className="bg-brand-indigo row-span-1 max-w-[280px] space-y-6 rounded-xl border p-4 max-sm:order-2 sm:p-8">
        ...
        {/* Premium */}
        <div className="bg-brand-indigo row-span-2 w-full max-w-[280px] space-y-6 rounded-xl border p-4 sm:p-8">
          <div className="flex flex-col items-center">
