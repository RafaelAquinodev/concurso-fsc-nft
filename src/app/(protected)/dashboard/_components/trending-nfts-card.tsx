...
const TrendingNftCard: React.FC<NftCardProps> = ({ collection }) => {
  ...
  return (
    <div className="group flex w-44 flex-shrink-0 cursor-pointer overflow-hidden rounded-xl border border-neutral-800 bg-neutral-900 transition-all duration-300 hover:scale-105 hover:border-purple-500">
      <div className="relative flex h-12 w-12 flex-shrink-0 items-center justify-center bg-neutral-800">
      ...
      <div className="flex min-w-0 flex-1 flex-col justify-between space-y-2 p-3">
