  ...
  return (
    <div className="gradient-border bg-brand-indigo col-span-1 rounded-xl p-6 xl:col-span-2">
      ...
      <div className="flex items-center justify-center">
        {loading && (
          <div className="flex h-48 w-[350px] animate-pulse items-center justify-center rounded-lg bg-[#282534]"></div>
        )}
        {error && (
          <div className="flex h-48 w-[350px] items-center justify-center rounded-lg bg-[#282534]">
            <p className="text-red-400">Erro ao carregar gráfico: {error}</p>
          </div>
        )}
      ...
      <div className="flex w-full items-center justify-center">
        {loading && (
          <div className="mt-4 flex h-[72px] w-[465px] animate-pulse items-center justify-center rounded-lg bg-[#282534]"></div>
        )}
        {error && (
          <div className="mt-4 flex h-[72px] w-[465px] items-center justify-center rounded-lg bg-[#282534]">
            <p className="text-red-400">Erro ao carregar gráfico: {error}</p>
          </div>
        )}
        {!loading && !error && performance && (
