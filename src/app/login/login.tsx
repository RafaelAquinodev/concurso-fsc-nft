          ...
          <div className="rounded-xl bg-pink-500 p-[4px]">
            <Card>
              ...
              <CardContent className="space-y-6">
                <div>
                  <label className="mb-3 block text-white">Email</label>
                  <div>
                    <input
                      className="h-[40px] w-full rounded-lg border-1 border-white p-[6px]"
                      type="email"
                ...
                <div>
                  <label className="mb-3 block text-white">Senha</label>
                  <div>
                    <input
                      className="h-[40px] w-full rounded-lg border-1 border-white p-[6px]"
                      type="password"
                ...
                <div>
                  <button className="h-[35px] w-full rounded-lg border-1 bg-pink-500">
                    Entrar
                  </button>
                </div>
                <div>
